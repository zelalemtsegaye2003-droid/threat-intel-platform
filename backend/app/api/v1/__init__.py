...
api_router.include_router(enrichment.router, prefix="/enrichment", tags=["Enrichment"])  # Phase 2
api_router.include_router(services.router, prefix="/services", tags=["Services"])  # Phase 3
